"""Reserved words taken from ``mage_ai.io.base.SQL_RESERVED_WORDS``.

**Generated — do not edit by hand.** The source is
``docs/data/mage_sql_reserved_words.json`` (mage_ai 0.9.79,
mage_ai/io/base.py SQL_RESERVED_WORDS); the generator is
...
#: 825 words, upper case, in the order they appear in the source.
